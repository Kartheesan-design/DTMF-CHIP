...
create_clock -name "m_clk" -add -period 8.0 -waveform {0.0 4.0} [get_pins DTMF_INST/TEST_CONTROL_INST/m_clk]
set_clock_transition 0.0 [get_clocks m_clk]
create_clock -name "m_rcc_clk" -add -period 16.0 -waveform {0.0 8.0} [get_pins DTMF_INST/TEST_CONTROL_INST/m_rcc_clk]
set_clock_transition 0.0 [get_clocks m_rcc_clk]
create_clock -name "m_spi_clk" -add -period 16.0 -waveform {0.0 8.0} [get_pins DTMF_INST/TEST_CONTROL_INST/m_spi_clk]
set_clock_transition 0.0 [get_clocks m_spi_clk]
create_clock -name "m_dsram_clk" -add -period 16.0 -waveform {0.0 8.0} [get_pins DTMF_INST/TEST_CONTROL_INST/m_dsram_clk]
set_clock_transition 0.0 [get_clocks m_dsram_clk]
create_clock -name "m_ram_clk" -add -period 16.0 -waveform {0.0 8.0} [get_pins DTMF_INST/TEST_CONTROL_INST/m_ram_clk]
set_clock_transition 0.0 [get_clocks m_ram_clk]
create_clock -name "m_digit_clk" -add -period 16.0 -waveform {0.0 8.0} [get_pins DTMF_INST/TEST_CONTROL_INST/m_digit_clk]
...
set_dont_touch [get_cells IOPADS_INST/*corner*]
